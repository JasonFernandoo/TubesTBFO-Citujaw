...
def compute_pda(input_string, parsed_lines):
    ...
    ,V^MM.    dM'       ` dM'       `   MM   d      MM   ,M9      MM        MM   d      MM     `Mb 
   ,M  `MM    MM          MM            MMmmMM      MMmmdM9       MM        MMmmMM      MM      MM 
   AbmmmqMA   MM.         MM.           MM   Y  ,   MM            MM        MM   Y  ,   MM     ,MP 
  A'     VML  `Mb.     ,' `Mb.     ,'   MM     ,M   MM            MM        MM     ,M   MM    ,dP' 
...
`7MM"""Mq.  `7MM"""YMM     `7MMF'`7MM"""YMM    .g8"""bgd MMP""MM""YMM `7MM"""YMM  `7MM"""Yb.   
  ...
  MM   ,M9    MM   d         MM    MM   d    dM'       `      MM        MM   d      MM     `Mb 
  MMmmdM9     MMmmMM         MM    MMmmMM    MM               MM        MMmmMM      MM      MM 
  MM  YM.     MM   Y  ,      MM    MM   Y  , MM.              MM        MM   Y  ,   MM     ,MP 
  MM   `Mb.   MM     ,M (O)  MM    MM     ,M `Mb.     ,'      MM        MM     ,M   MM    ,dP' 
.JMML. .JMM..JMMmmmmMMM  Ymmm9   .JMMmmmmMMM   `"bmmmd'     .JMML.    .JMMmmmmMMM .JMMmmmdP'                                                                                                                                                                                            
            ''')
...
def main():
    ...
    print(f"File name: {args.html_file}")
    print()
    print(content)
    print()
    print(f'Computing the Transition Table for {args.html_file}:')
    loader()
